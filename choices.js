module.exports = {
	...
	// 2200 MENU
	CHOICES_MENU_2200: [
		{ id: '0', label: 'UP', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x85, 0x00, 0x02, 0x00]) },
		{ id: '1', label: 'DOWN', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x07, 0x00, 0x01, 0x00, 0x00, 0x00]) },
		{ id: '2', label: 'LEFT', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x85, 0x00, 0x02, 0x00]) },
		{ id: '3', label: 'RIGHT', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x85, 0x00, 0x02, 0x00]) },
		{ id: '4', label: 'ENTER', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x85, 0x00, 0x02, 0x00]) },
		{ id: '5', label: 'MENU', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x85, 0x00, 0x02, 0x00]) },
	],
