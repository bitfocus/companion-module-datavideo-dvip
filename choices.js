module.exports = {
	...
	CHOICES_AUDIO_SRC_2200: [
		{ id: '0', label: 'Fixed', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00]) },
		{ id: '1', label: 'Follow', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06, 0x00, 0x01, 0x00, 0x00, 0x00]) },
	],
	// 2200 Keyer
	CHOICES_KEYER_2200: [
	...
	CHOICES_TRANS_2200: [
		...
		{ id: '4', label: 'Mix', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x58, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00]) },
		{ id: '5', label: 'Wipe', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x58, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00]) },
		{ id: '6', label: 'Freeze', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x58, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00]) },
		{ id: '7', label: 'Speed 1', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x58, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00]) },
		{ id: '8', label: 'Speed 2', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x58, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00]) },
		{ id: '8', label: 'Speed 3', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x58, 0x00, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00]) },
	],
	...
	CHOICES_LOGO_2200: [
		{ id: '0', label: 'LOGO 1', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x04, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00]) },
		{ id: '2', label: 'LOGO 2', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x03, 0x04, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00]) },
		{ id: '4', label: 'CLOCK', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x03, 0x04, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00]) },
	],

	CHOICES_CROSSPOINT_2200: [
		{ id: '0', label: 'FS', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x04, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00]) },
		{ id: '1', label: 'AUX', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x03, 0x04, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00]) },
		{ id: '2', label: 'VIDEO', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x03, 0x04, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00]) },
		{ id: '3', label: 'AUDIO', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x03, 0x04, 0x02, 0x00, 0x01, 0x00, 0x00, 0x00]) },
	],

	CHOICES_SWITCH_HDMI1_2200: [
		{ id: '1', label: 'MS/PGM', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x0f, 0x00, 0x05, 0x00, 0x1b, 0x00, 0x00, 0x00]) },
	],

	CHOICES_WIPE_2200: [
		{ id: '0', label: 'Wipe 1', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x01, 0x00, 0x00, 0x00]) },
		{ id: '1', label: 'Wipe 2', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '2', label: 'Wipe 3', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '3', label: 'Wipe 4', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '4', label: 'Wipe 5', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '5', label: 'Wipe 6', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '6', label: 'Wipe 7', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '7', label: 'Wipe 8', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '8', label: 'Wipe 9', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '9', label: 'Wipe 10', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '10', label: 'Wipe 11', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '11', label: 'Wipe 12', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '12', label: 'Wipe 13', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '13', label: 'Wipe 14', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '14', label: 'Wipe 15', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '15', label: 'Wipe 16', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '16', label: 'Wipe 17', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
		{ id: '17', label: 'Wipe 18', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x05, 0x00, 0x00, 0x00]) },
	],
