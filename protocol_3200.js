module.exports = {
	...
	GET_SET_CMD_3200: [{
		...
		{
			id: 4,
			label: "STATUS_FIRMWARE_VERSION",
			type: "int",
		},
		{
			id: 5,
			label: "STATUS_KBD_VERSION",
			type: "int",
		},
		{
			id: 6,
			label: "STATUS_BOARD_VERSION",
			type: "int",
		},
		{
			id: 7,
			label: "STATUS_PRODUCT_VERSION",
			type: "int",
		},
		{
			id: 8,
			label: "STATUS_PRODUCT_SUBVERSION",
			type: "int",
		},
		{
			id: 9,
			label: "STATUS_BOOT_STATUS",
			type: "int",
		},
		{
			id: 10,
		...
		{
			id: 36,
			label: "STATUS_TALLY_KEY3_FILL_SRC",
			type: "int",
		},
		{
			id: 37,
		...
		{
			id: 38,
			label: "STATUS_TALLY_KEY4_FILL_SRC",
			type: "int",
		},
		{
			id: 39,
	...
	},
	{
		...
		controls: [{
			...
			values: [{
				id: 0,
				label: "DV_STD_HD1080P_60"
			},
			{
				id: 1,
				label: "DV_STD_HD1080P_59_94"
			},
			{
				id: 2,
				label: "DV_STD_HD1080P_50"
			},
			{
				id: 3,
	...
	},
	{
		...
		controls: [
			...
			//SE3200 is the same up to here
			{
				id: 79,
				label: "SWITCHER_KEY3_KEYER_ON",
				type: "int",
			},
			{
				id: 80,
				label: "SWITCHER_KEY3_KEY_SRC",
				type: "int",
			},
			{
				id: 81,
				label: "SWITCHER_KEY3_SPLIT_SRC",
				type: "int",
			},
			{
				id: 82,
				label: "SWITCHER_KEY3_LINEAR_OPACITY",
				type: "float",
			},
			{
				id: 83,
				label: "SWITCHER_KEY3_LINEAR_LIFT",
				type: "float",
			},
			{
				id: 84,
				label: "SWITCHER_KEY3_LINEAR_GAIN",
				type: "float",
			},
			{
				id: 85,
				label: "SWITCHER_KEY3_LINEAR_KEY_MODE",
				type: "int",
			},
			{
				id: 86,
				label: "SWITCHER_KEY3_LINEAR_KEY_INVERT",
				type: "float",
			},
			{
				id: 87,
				label: "SWITCHER_KEY3_LINEAR_KEY_SEL_MODE",
				type: "int",
			},
			{
				id: 88,
				label: "SWITCHER_KEY3_LINEAR_KEY_FILL_MODE",
				type: "int",
			},
			{
				id: 89,
				label: "SWITCHER_KEY3_LINEAR_MATTE_HUE",
				type: "float",
			},
			{
				id: 90,
				label: "SWITCHER_KEY3_LINEAR_MATTE_SAT",
				type: "float",
			},
			{
				id: 91,
				label: "SWITCHER_KEY3_LINEAR_MATTE_LUMA",
				type: "float",
			},
			{
				id: 92,
				label: "SWITCHER_KEY3_CHROMA_ENABLE",
				type: "int",
			},
			{
				id: 93,
				label: "SWITCHER_KEY3_CHROMA_MATTE_HUE",
				type: "float",
			},
			{
				id: 94,
				label: "SWITCHER_KEY3_CHROMA_MATTE_SAT",
				type: "float",
			},
			{
				id: 95,
				label: "SWITCHER_KEY3_CHROMA_MATTE_LUMA",
				type: "float",
			},
			{
				id: 96,
				label: "SWITCHER_KEY3_CHROMA_KEY_ACC",
				type: "float",
			},
			{
				id: 97,
				label: "SWITCHER_KEY3_CHROMA_KEY_GAIN",
				type: "float",
			},
			{
				id: 98,
				label: "SWITCHER_KEY3_CHROMA_KEY_LIFT",
				type: "float",
			},
			{
				id: 99,
				label: "SWITCHER_KEY3_CHROMA_CHROMA_ACC",
				type: "float",
			},
			{
				id: 100,
				label: "SWITCHER_KEY3_CHROMA_CHROMA_SUP",
				type: "float",
			},
			{
				id: 101,
				label: "SWITCHER_KEY3_CHROMA_KEY_SOFT",
				type: "float",
			},
			{
				id: 102,
				label: "SWITCHER_KEY3_CHROMA_KEY_SHRINK",
				type: "float",
			},
			{
				id: 103,
				label: "SWITCHER_KEY3_CHROMA_BGND_SUPPRESS",
				type: "int",
			},
			{
				id: 104,
				label: "SWITCHER_KEY3_MASK_LEFT",
				type: "float",
			},
			{
				id: 105,
				label: "SWITCHER_KEY3_MASK_RIGHT",
				type: "float",
			},
			{
				id: 106,
				label: "SWITCHER_KEY3_MASK_TOP",
				type: "float",
			},
			{
				id: 107,
				label: "SWITCHER_KEY3_MASK_BOTTOM",
				type: "float",
			},
			{
				id: 108,
				label: "SWITCHER_KEY3_MASK_ENABLE",
				type: "int",
			},
			{
				id: 109,
				label: "SWITCHER_KEY4_KEYER_ON",
				type: "int",
			},
			{
				id: 110,
				label: "SWITCHER_KEY4_KEY_SRC",
				type: "int",
			},
			{
				id: 111,
				label: "SWITCHER_KEY4_SPLIT_SRC",
				type: "int",
			},
			{
				id: 112,
				label: "SWITCHER_KEY4_LINEAR_OPACITY",
				type: "float",
			},
			{
				id: 113,
				label: "SWITCHER_KEY4_LINEAR_LIFT",
				type: "float",
			},
			{
				id: 114,
				label: "SWITCHER_KEY4_LINEAR_GAIN",
				type: "float",
			},
			{
				id: 115,
				label: "SWITCHER_KEY4_LINEAR_KEY_MODE",
				type: "int",
			},
			{
				id: 116,
				label: "SWITCHER_KEY4_LINEAR_KEY_INVERT",
				type: "float",
			},
			{
				id: 117,
				label: "SWITCHER_KEY4_LINEAR_KEY_SEL_MODE",
				type: "int",
			},
			{
				id: 118,
				label: "SWITCHER_KEY4_LINEAR_KEY_FILL_MODE",
				type: "int",
			},
			{
				id: 119,
				label: "SWITCHER_KEY4_LINEAR_MATTE_HUE",
				type: "float",
			},
			{
				id: 120,
				label: "SWITCHER_KEY4_LINEAR_MATTE_SAT",
				type: "float",
			},
			{
				id: 121,
				label: "SWITCHER_KEY4_LINEAR_MATTE_LUMA",
				type: "float",
			},
			{
				id: 122,
				label: "SWITCHER_KEY4_CHROMA_ENABLE",
				type: "int",
			},
			{
				id: 123,
				label: "SWITCHER_KEY4_CHROMA_MATTE_HUE",
				type: "float",
			},
			{
				id: 124,
				label: "SWITCHER_KEY4_CHROMA_MATTE_SAT",
				type: "float",
			},
			{
				id: 125,
				label: "SWITCHER_KEY4_CHROMA_MATTE_LUMA",
				type: "float",
			},
			{
				id: 126,
				label: "SWITCHER_KEY4_CHROMA_KEY_ACC",
				type: "float",
			},
			{
				id: 127,
				label: "SWITCHER_KEY4_CHROMA_KEY_GAIN",
				type: "float",
			},
			{
				id: 128,
				label: "SWITCHER_KEY4_CHROMA_KEY_LIFT",
				type: "float",
			},
			{
				id: 129,
				label: "SWITCHER_KEY4_CHROMA_CHROMA_ACC",
				type: "float",
			},
			{
				id: 130,
				label: "SWITCHER_KEY4_CHROMA_CHROMA_SUP",
				type: "float",
			},
			{
				id: 131,
				label: "SWITCHER_KEY4_CHROMA_KEY_SOFT",
				type: "float",
			},
			{
				id: 132,
				label: "SWITCHER_KEY4_CHROMA_KEY_SHRINK",
				type: "float",
			},
			{
				id: 133,
				label: "SWITCHER_KEY4_CHROMA_BGND_SUPPRESS",
				type: "int",
			},
			{
				id: 134,
				label: "SWITCHER_KEY4_MASK_LEFT",
				type: "float",
			},
			{
				id: 135,
				label: "SWITCHER_KEY4_MASK_RIGHT",
				type: "float",
			},
			{
				id: 136,
				label: "SWITCHER_KEY4_MASK_TOP",
				type: "float",
			},
			{
				id: 137,
				label: "SWITCHER_KEY4_MASK_BOTTOM",
				type: "float",
			},
			{
				id: 138,
				label: "SWITCHER_KEY4_MASK_ENABLE",
				type: "int",
			},
			...
			{
				id: 142,
				label: "SWITCHER_TRANS_KEY3",
				type: "flag",
			},
			{
				id: 143,
				label: "SWITCHER_TRANS_KEY4",
				type: "flag",
			},
			{
				id: 144,
			...
			{
				id: 201,
				label: "SWITCHER_FLEX_SRC_DVE3_SRC",
				type: "int",
			},
			{
				id: 202,
				label: "SWITCHER_FLEX_SRC_DVE4_SRC",
				type: "int",
			},
			{
				id: 203,
	...
	},
	{
		...
		controls: [
			...
			{
				id: 25,
				label: "OUTPUT_HDMI_OUT1_1080_MODE",
				type: "int",
			},
			{
				id: 26,
				label: "OUTPUT_HDMI_OUT2_1080_MODE",
				type: "int",
			},
			{
				id: 27,
				label: "OUTPUT_HDMI_OUT3_1080_MODE",
				type: "int",
			},
			{
				id: 28,
	...
	},
	{
		...
		{
			id: 3,
			label: "AUDIO_ANALOG_LEVEL",
			type: "int",
		},
		{
			id: 4,
			label: "AUDIO_AUDIO_OUT_SOURCE",
			type: "int",
		},
		{
			id: 5,
			label: "AUDIO_AUDIO_IN_MODE",
			type: "int",
		},
		{
			id: 6,
			label: "AUDIO_AUDIO_OUT_MODE",
			type: "int",
		},
		{
			id: 7,
			label: "AUDIO_MIXER_MODE",
			type: "int",
		},
		{
			id: 8,
			label: "AUDIO_MASTER_GAIN",
			type: "int",
		},
		{
			id: 9,
			label: "AUDIO_MASTER_DELAY",
			type: "int",
		},
		{
			id: 10,
			label: "AUDIO_AUDIO_OUT_GAIN",
			type: "int",
		},
		{
			id: 11,
			label: "AUDIO_AUDIO_OUT_DELAY",
			type: "int",
		},
		{
			id: 12,
		...
		{
			id: 14,
			label: "AUDIO_SDI3_ENABLE",
			type: "int",
		},
		{
			id: 15,
			label: "AUDIO_SDI4_ENABLE",
			type: "int",
		},
		{
			id: 16,
			label: "AUDIO_SDI5_ENABLE",
			type: "int",
		},
		{
			id: 17,
			label: "AUDIO_SDI6_ENABLE",
			type: "int",
		},
		{
			id: 18,
		...
		{
			id: 19,
			label: "AUDIO_HDMI2_ENABLE",
			type: "int",
		},
		{
			id: 20,
			label: "AUDIO_HDMI3_ENABLE",
			type: "int",
		},
		{
			id: 21,
			label: "AUDIO_INPUT1_GAIN",
			type: "int",
		},
		{
			id: 22,
			label: "AUDIO_INPUT1_DELAY",
			type: "int",
		},
		{
			id: 23,
			label: "AUDIO_INPUT2_GAIN",
			type: "int",
		},
		{
			id: 24,
			label: "AUDIO_INPUT2_DELAY",
			type: "int",
		},
		{
			id: 25,
			label: "AUDIO_INPUT3_GAIN",
			type: "int",
		},
		{
			id: 26,
			label: "AUDIO_INPUT3_DELAY",
			type: "int",
		},
		{
			id: 27,
			label: "AUDIO_INPUT4_GAIN",
			type: "int",
		},
		{
			id: 28,
			label: "AUDIO_INPUT4_DELAY",
			type: "int",
		},
		{
			id: 29,
			label: "AUDIO_INPUT5_GAIN",
			type: "int",
		},
		{
			id: 30,
			label: "AUDIO_INPUT5_DELAY",
			type: "int",
		},
		{
			id: 31,
			label: "AUDIO_INPUT6_GAIN",
			type: "int",
		},
		{
			id: 32,
			label: "AUDIO_INPUT6_DELAY",
			type: "int",
		},
		{
			id: 33,
			label: "AUDIO_INPUT7_GAIN",
			type: "int",
		},
		{
			id: 34,
			label: "AUDIO_INPUT7_DELAY",
			type: "int",
		},
		{
			id: 35,
			label: "AUDIO_INPUT8_GAIN",
			type: "int",
		},
		{
			id: 36,
			label: "AUDIO_INPUT8_DELAY",
			type: "int",
		},
		{
			id: 37,
			label: "AUDIO_INPUT9_GAIN",
			type: "int",
		},
		{
			id: 38,
			label: "AUDIO_INPUT9_DELAY",
			type: "int",
		},
		{
			id: 39,
			label: "AUDIO_INPUT10_GAIN",
			type: "int",
		},
		{
			id: 40,
			label: "AUDIO_INPUT10_DELAY",
			type: "int",
		},
		{
			id: 41,
			label: "AUDIO_INPUT11_GAIN",
			type: "int",
		},
		{
			id: 42,
			label: "AUDIO_INPUT11_DELAY",
			type: "int",
		},
		{
			id: 43,
			label: "AUDIO_INPUT12_GAIN",
			type: "int",
		},
		{
			id: 44,
			label: "AUDIO_INPUT12_DELAY",
			type: "int",
		},
		]
	},
