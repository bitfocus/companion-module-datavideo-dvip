module.exports = {
	...
	CHOICES_MENU_3200: [
		...
		//3200 Standard
		CHOICES_SET_STANDARD_3200: [
			{ id: '0', label: '1080p 60', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00]) },
			{ id: '1', label: '1080p 59.94', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00]) }, 
			{ id: '2', label: '1080p 50', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00]) },
			{ id: '3', label: '1080i 60', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x03, 0x00, 0x00, 0x00]) },
			{ id: '4', label: '1080i 59.94', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x04, 0x00, 0x00, 0x00]) }, 
			{ id: '5', label: '1080i 50', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x05, 0x00, 0x00, 0x00]) },
			{ id: '6', label: '720p 60', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x06, 0x00, 0x00, 0x00]) },
			{ id: '7', label: '720p 59.94', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x07, 0x00, 0x00, 0x00]) },
			{ id: '8', label: '720p 50', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x08, 0x00, 0x00, 0x00]) },
		],
	////1200////
	...
	//1200 Standard
	CHOICES_SET_STANDARD_1200: [
		{ id: '0', label: '1080i 60', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00]) },
		{ id: '1', label: '1080i 59.94', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00]) }, 
		{ id: '2', label: '1080i 50', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00]) },
		{ id: '3', label: '720p 60', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x03, 0x00, 0x00, 0x00]) },
		{ id: '4', label: '720p 59.94', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x04, 0x00, 0x00, 0x00]) },
		{ id: '5', label: '720p 50', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x05, 0x00, 0x00, 0x00]) },
	],
