module.exports = {
	...
	//3200 Keyer
	CHOICES_KEYER_3200: [
		{ id: '0', label: 'DSK 1 PGM', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x99, 0x00, 0x02, 0x00]) },
		{ id: '2', label: 'DSK 1 PVW', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0xbd, 0x00, 0x02, 0x00]) },

		{ id: '4', label: 'DSK 2 PGM', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0xab, 0x00, 0x02, 0x00]) },
		{ id: '6', label: 'DSK 2 PVW', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0xbe, 0x00, 0x02, 0x00]) },

		{ id: '8', label: 'KEY 1 PGM', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x13, 0x00, 0x02, 0x00]) },
		{ id: '10', label: 'KEY 1 PVW', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x8c, 0x00, 0x02, 0x00]) },

		{ id: '12', label: 'KEY 2 PGM', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x31, 0x00, 0x02, 0x00]) },
		{ id: '14', label: 'KEY 2 PVW', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x8d, 0x00, 0x02, 0x00]) },

		{ id: '16', label: 'KEY 3 PGM', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x4f, 0x00, 0x02, 0x00]) },
		{ id: '18', label: 'KEY 3 PVW', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x8e, 0x00, 0x02, 0x00]) },

		{ id: '20', label: 'KEY 4 PGM', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x6d, 0x00, 0x02, 0x00]) },
		{ id: '22', label: 'KEY 4 PVW', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x8f, 0x00, 0x02, 0x00]) },
	],
	// 3200 Fade to Black
	CHOICES_FTB_3200: [
	...
	// 1200 Keyer
	CHOICES_KEYER_1200: [
		{ id: '0', label: 'DSK 1 PGM', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x5b, 0x00, 0x02, 0x00]) },
		{ id: '2', label: 'DSK 1 PVW', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x7f, 0x00, 0x02, 0x00]) },

		{ id: '4', label: 'DSK 2 PGM', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x6d, 0x00, 0x02, 0x00]) },
		{ id: '6', label: 'DSK 2 PVW', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x80, 0x00, 0x02, 0x00]) },

		{ id: '8', label: 'KEY 1 PGM', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x13, 0x00, 0x02, 0x00]) },
		{ id: '10', label: 'KEY 1 PVW', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x50, 0x00, 0x02, 0x00]) },

		{ id: '12', label: 'KEY 2 PGM', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x31, 0x00, 0x02, 0x00]) },
		{ id: '14', label: 'KEY 2 PVW', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x51, 0x00, 0x02, 0x00]) },
	],
	// 1200 Streamer
	...
	CHOICES_KEYER_700: [
		...
		{ id: '12', label: 'P-in-P PGM', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x31, 0x00, 0x02, 0x00]) },
		{ id: '14', label: 'P-in-P PVW', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x51, 0x00, 0x02, 0x00]) },
	],
	// 700 Audio
	CHOICES_AUDIO_700: [
		{ id: '8', label: 'External Audio ON', cmd: Buffer.from([0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x06, 0x00, 0x02, 0x00, 0x00, 0x00]) },
