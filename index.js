...
class instance extends instance_skel {
	...
	constructor(system, id, config) {
		...
		this.CHOICES_SWITCH_PGM_1200 = [
			...
			{ id: '7', label: 'Matte', cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x56, 0x00, 0x02, 0x00, 0x11, 0x00, 0x00, 0x00]) },
			{ id: '8', label: 'Bars', cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x56, 0x00, 0x02, 0x00, 0x12, 0x00, 0x00, 0x00]) },
		...
		this.CHOICES_SWITCH_PGM_3200 = [
			...
			{ id: '13', label: 'Matte', 	cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x94, 0x00, 0x02, 0x00, 0x11, 0x00, 0x00, 0x00]) },
			{ id: '14', label: 'Bars', 		cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x94, 0x00, 0x02, 0x00, 0x12, 0x00, 0x00, 0x00]) },
		];
	  ...
	  // Switch 3200 Preview Bus
		this.CHOICES_SWITCH_PVW_3200 = [
			...
			{ id: '13', label: 'Matte', 	cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x95, 0x00, 0x02, 0x00, 0x11, 0x00, 0x00, 0x00]) },
			{ id: '14', label: 'Bars', 		cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x95, 0x00, 0x02, 0x00, 0x12, 0x00, 0x00, 0x00]) },
		];
		...
		this.CHOICES_SWITCH_PVW_1200 = [
			...
			{ id: '7', label: 'Matte', cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x00, 0x02, 0x00, 0x11, 0x00, 0x00, 0x00]) },
			{ id: '8', label: 'Bars', cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x00, 0x02, 0x00, 0x12, 0x00, 0x00, 0x00]) },
		];
		...
		this.CHOICES_SWITCH_KEY1_1200 = [
			...
			{ id: '7', label: 'Matte', cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x14, 0x00, 0x02, 0x00, 0x11, 0x00, 0x00, 0x00]) },
			{ id: '8', label: 'Bars', cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x14, 0x00, 0x02, 0x00, 0x12, 0x00, 0x00, 0x00]) },
		];
		...
		this.CHOICES_SWITCH_KEY2_1200 = [
			...
			{ id: '7', label: 'Matte', cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x32, 0x00, 0x02, 0x00, 0x11, 0x00, 0x00, 0x00]) },
			{ id: '8', label: 'Bars', cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x32, 0x00, 0x02, 0x00, 0x12, 0x00, 0x00, 0x00]) },
		];
		...
		this.CHOICES_SWITCH_DSK1_1200 = [
			...
			{ id: '7', label: 'Matte', cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5c, 0x00, 0x02, 0x00, 0x11, 0x00, 0x00, 0x00]) },
			{ id: '8', label: 'Bars', cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5c, 0x00, 0x02, 0x00, 0x12, 0x00, 0x00, 0x00]) },
		];
		...
		this.CHOICES_SWITCH_DSK2_1200 = [
			...
			{ id: '7', label: 'Matte', cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x6e, 0x00, 0x02, 0x00, 0x11, 0x00, 0x00, 0x00]) },
			{ id: '8', label: 'Bars', cmd: new Buffer([0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x6e, 0x00, 0x02, 0x00, 0x12, 0x00, 0x00, 0x00]) },
		];
